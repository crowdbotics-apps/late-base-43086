"""
Django settings for late_base_43086 project.
...
ROOT_URLCONF = 'late_base_43086.urls'
...
WSGI_APPLICATION = 'late_base_43086.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_base_43086 API",
    "DESCRIPTION": "API documentation for late_base_43086 App",
    "VERSION": "v1",
}
